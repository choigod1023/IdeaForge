  ...
  return (
    <div className="pb-6 border-b border-gray-100">
      ...
      <div className="flex flex-wrap gap-2 mt-4">
        <span className="px-3 py-1.5 text-sm font-medium text-indigo-700 bg-indigo-50 rounded-xl">
          {project.difficulty}
        </span>
        {project.category && (
          <span className="px-3 py-1.5 text-sm font-medium text-green-700 bg-green-50 rounded-xl">
            {project.category}
          </span>
        )}
        {project.theme && (
          <span className="px-3 py-1.5 text-sm font-medium text-purple-700 bg-purple-50 rounded-xl">
            {project.theme}
          </span>
        )}
      </div>
