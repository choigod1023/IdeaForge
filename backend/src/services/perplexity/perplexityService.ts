...
기술 스택 선호도 규칙:
1. 선호하는 기술 스택의 학습 자료를 우선적으로 제공
2. 선호하지 않는 기술 스택의 자료는 제외 (예: Python, matplotlib 등)
3. 선호 기술 스택의 최신 버전과 트렌드를 반영한 자료만 포함
4. 선호 기술 스택의 공식 문서와 채널의 자료를 우선적으로 포함
5. 선호 기술 스택의 생태계와 도구에 대한 자료를 포함
